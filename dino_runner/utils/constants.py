...
#SOUND_GAME = os.path.join(os.path.dirname(__file__), "..", "assets")
#SOUND_PLAYING = os.path.join(SOUND_GAME,'SoundGame.mp3')
...
ROCK = [
    pygame.image.load(os.path.join(IMG_DIR, "Rock/Rock2.png")),
]
...
CLOUD = pygame.image.load(os.path.join(IMG_DIR, 'Other/CLOUD_3.png'))
SHIELD = pygame.image.load(os.path.join(IMG_DIR, 'Other/shield.png'))
HAMMER = pygame.image.load(os.path.join(IMG_DIR, 'Other/hammer.png'))

BG = pygame.image.load(os.path.join(IMG_DIR, 'Other/Track.png'))
TRK = pygame.image.load(os.path.join(IMG_DIR, 'Other/Track3.png'))
